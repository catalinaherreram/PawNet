...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($_FILES["foto"]["tmp_name"], $foto)) {
        $sql = "INSERT INTO encontrados (iduser, fecha, tipo, ciudad, descripcion, email, telefono, foto) 
